...
namespace Mmocontroller.Client
{
  public static class KeyMap
  {
    ...
    public static string ReverseMapping(KeyCode binding)
    {
      return ReverseMap[new KeyCode[] { binding }];
    }
    ...
    static KeyMap()
    {
      ...
      Keymap.Add("LMB", new KeyCode[] { KeyCode.Mouse0 });
      Keymap.Add("RMB", new KeyCode[] { KeyCode.Mouse1 });
      Keymap.Add("MMB", new KeyCode[] { KeyCode.Mouse2 });
      Keymap.Add("Esc", new KeyCode[] { KeyCode.Escape });
